...
public class ImageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    File createImageFile() throws IOException {
        ...
        String imageFileName = getIntent().getStringExtra("Pname");
    ...
    private File getOutputMediaFile(int type) {
        ...
        if (type == MEDIA_TYPE_IMAGE) {
            mediaFile = new File(imageFileName + ".jpg");
        }  else {
            return null;
        }
    ...
    private void uploadFile() {
        if (postPath == null || postPath.equals("")) {
            ...
            map.put("file\"; filename=\"" + imageFileName+".jpg" + "\"", requestBody);
            ApiInterface getResponse = Api.getClient();
            Call<Products> call = getResponse.upload("token", map);
                ...
                public void onResponse(Call<Products> call, Response<Products> response) {
                    if (response.isSuccessful()){
                        if (response.body() != null){
                            hidepDialog();
                            Products serverResponse = response.body();
